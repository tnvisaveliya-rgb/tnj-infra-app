...
function AddSiteVendorPage() {
  ...
  const exportToExcel = (dataList, siteTitle, tabName) => {
    ...
    if (tabName === 'vendors') tabTitleHeading = "Supplier List";
    else if (tabName === 'parties') tabTitleHeading = "Outward Party List";
    else if (tabName === 'contractors') tabTitleHeading = "Labour List";
    ...
    <div style={{ padding: '16px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Inter, sans-serif', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', backgroundColor: '#fff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0', width: '100%', boxSizing: 'border-box' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          <button onClick={() => setActiveModal('vendor')} style={{ backgroundColor: '#059669', color: '#fff', padding: '12px', borderRadius: '8px', border: 'none', fontWeight: '600', fontSize: '13px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', width: '100%' }}><Plus size={16} /> Add Supplier</button>
          ...
          <button onClick={() => setActiveModal('contractor')} style={{ backgroundColor: '#9333ea', color: '#fff', padding: '12px', borderRadius: '8px', border: 'none', fontWeight: '600', fontSize: '13px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', width: '100%' }}><Plus size={16} /> Add Labour</button>
          ...
          <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '20px', width: '100%', maxWidth: '400px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', borderBottom: '1px solid #f1f5f9', paddingBottom: '8px' }}>
              <h3 style={{ fontSize: '15px', fontWeight: 'bold', color: '#0f172a', margin: 0 }}>
                {activeModal === 'site' ? '🏗️ Add New Site' : activeModal === 'vendor' ? '🏢 Add New Supplier' : activeModal === 'party' ? '🚚 Add Outward Party' : activeModal === 'contractor' ? '👷 Add New Labour' : activeModal === 'material' ? '📦 Add Site Material' : '📝 Add Work Description'}
              </h3>
        ...
        <div style={{ marginTop: '24px', backgroundColor: '#fff', padding: '16px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
              ...
              <button onClick={() => setViewTab('contractors')} style={{ padding: '6px 12px', borderRadius: '6px', border: 'none', background: viewTab === 'contractors' ? '#9333ea' : '#f1f5f9', color: viewTab === 'contractors' ? '#fff' : '#475569', fontWeight: '600', fontSize: '12px', cursor: 'pointer' }}>Labour ({filteredContractors.length})</button>
          ...
          <div style={{ backgroundColor: '#f8fafc', padding: '10px 14px', borderRadius: '8px', borderLeft: '4px solid #0284c7', marginBottom: '12px' }}>
            <h4 style={{ fontSize: '13px', fontWeight: 'bold', color: '#0f172a', margin: 0 }}>
              {filterViewSite === 'all' ? '🌐 All Sites' : `🏗️ Site: ${filterViewSite}`} — <span style={{ color: '#059669' }}>{viewTab === 'vendors' ? 'SUPPLIERS' : viewTab === 'contractors' ? 'LABOUR' : viewTab.toUpperCase()} LIST</span>
            </h4>
          </div>
          ...
          {/* CONTRACTORS / LABOUR LIST */}
          {viewTab === 'contractors' && (
            <div>
              {filteredContractors.length === 0 ? <p style={{ fontSize: '12px', color: '#64748b' }}>No labour found.</p> : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  ...
                  {filteredMaterials.map(m => (
                    <div key={m.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 12px', backgroundColor: '#fff', borderRadius: '6px', border: '1px solid #e2e8f0', fontSize: '12px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                        {editingId === m.id ? (
                          <>
                            <input value={editName} onChange={(e) => setEditName(e.target.value)} style={{ padding: '4px', fontSize: '11px' }} />
                          ...
                          <>
                            <button onClick={() => { setEditingId(m.id); setEditName(m.name); }} style={{ background: 'none', border: 'none', color: '#2563eb', cursor: 'pointer' }}><Edit2 size={14} /></button>
                    ...
                    <div key={w.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 12px', backgroundColor: '#fff', borderRadius: '6px', border: '1px solid #e2e8f0', fontSize: '12px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                        {editingId === w.id ? (
                          ...
                          <>
                            <button onClick={() => { setEditingId(w.id); setEditName(w.name); }} style={{ background: 'none', border: 'none', color: '#2563eb', cursor: 'pointer' }}><Edit2 size={14} /></button>
